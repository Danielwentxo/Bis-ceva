...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-8GGCS5vs.mjs");
...
var manifest = {
	"0953cbb8aab4b2e8d6449bbc04970d13e3410c3831e1f3f1633c3177c3b43000": {
		functionName: "searchArtists_createServerFn_handler",
		importer: () => import("./artist-api-DiyJeuJX.mjs")
	},
	"7cd086ba5327cb686a1d0157fc1ff52fd338c3c9c5fc11d38bcc15b6b1bfd8bf": {
		functionName: "enrichArtists_createServerFn_handler",
		importer: () => import("./artist-api-DiyJeuJX.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-EuZSQXDo.mjs").then((n) => n.t),
