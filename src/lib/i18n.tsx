...
const dict: Record<Locale, Record<string, string>> = {
  en: {
    ...
    artistsHint: "The first artist is the headliner. Logos come from TheAudioDB and Deezer. Drag to reorder.",
  ...
  fr: {
    ...
    emptyTitle: "Votre archive est prête",
  ...
  de: {
    ...
    emptyTitle: "Dein Archiv ist bereit",
  ...
  es: {
    ...
    emptyTitle: "Tu archivo está listo",
