export const I18N_EXTRA: Record<string, Record<string, string>> = {
  en: {
    ...
    exportTitle: "Export",
    importTitle: "Import CSV or JSON",
    onboardBody: "Add last night\u2019s show, or import the list you already keep.",
    onboardAdd: "Add last concert",
    onboardImport: "Import a spreadsheet",
